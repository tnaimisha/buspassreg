...
<FORM action="change4.jsp" method="get">
...
if(name!="" && collegename!="" && rollno!="" && mailid!="" && pass!=null) {

try {

connection = DriverManager.getConnection(connectionURL,"root","chinni");

String queryString = "INSERT INTO new(name,collegename,rollno,mailid,pass) VALUES (?, ?, ?,?,?)";
